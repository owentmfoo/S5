...
def from_era5(stationfile, gribfile, start_date, end_date, outfile="Weather-era5byS5.dat", Solar=True):
    ...
    weather_dat.data.loc[:, 'Time (HHMM)'] = weather_dat.data.loc[:, 'Time (HHMM)'].astype('str').str.pad(width=4,
                                                                                                          side='left',
                                                                                                          fillchar='0')
...
if __name__ == '__main__':
    ...
    from_era5(stationfile, gribfile, start_date, end_date, outfile='E:\solar_car_race_strategy\S5\Weather-era5byS5.dat',
              Solar=True)
